    ...
    public class ColourPalette : BaseTypes.ICustomItemGrabMenuItem.BasicComponent {
      ...
      protected override Texture2D GetTexture(GraphicsDevice device) {
        if (_colourPalette is null || this.texture is null) {
          ...
          using var gradientFadeToBlack = new System.Drawing.Drawing2D.LinearGradientBrush(new System.Drawing.RectangleF(0f, 0f, bounds.Width, bounds.Height * 0.4f), System.Drawing.Color.FromArgb(255, 1, 1, 1), System.Drawing.Color.Transparent, 90f);
          ...
          graphics.FillRectangle(gradientFadeToWhite, 0f, (bounds.Height * 0.6f) + 1f /* just some glitch */, bounds.Width, bounds.Height * 0.4f);
      ...
      public Color GetColourAt(Int32 x, Int32 y) {
        ...
        return (colour.R | colour.G | colour.B) == 0 ? new Color(1, 1, 1) : colour;
      }
      ...
      public override void OnGameWindowSizeChanged(Rectangle oldBounds, Rectangle newBounds) {
        // calc new bounds
        this.Bounds = this.HostMenuItem.HostMenu.ItemsToGrabMenu.GetContentRectangle();
