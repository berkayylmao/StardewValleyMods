...
namespace ChestEx.LanguageExtensions {
  ...
  public static class SVExtensions {
    ...
    public static Rectangle GetDialogueBoxRectangle(this InventoryMenu menu) {
      var _lastSlot = menu.GetSlotDrawPositions().Last().AsXNAPoint();

      return new Rectangle(
            menu.xPositionOnScreen - 36,
            menu.yPositionOnScreen - IClickableMenu.spaceToClearTopBorder - 12,
            _lastSlot.X + ((IClickableMenu.borderWidth + 32) * 2) - menu.xPositionOnScreen,
            _lastSlot.Y + ((IClickableMenu.spaceToClearTopBorder + 10) * 2) - menu.yPositionOnScreen
         );
    }
    ...
    public static Rectangle GetContentRectangle(this InventoryMenu menu) {
      ...
      return new Rectangle(
            ...
            _lastSlot.X + IClickableMenu.borderWidth + 28 - menu.xPositionOnScreen,
            _lastSlot.Y + IClickableMenu.spaceToClearTopBorder - 24 - menu.yPositionOnScreen
         );
    }
    ...
    /// </summary>
    public static void SetBounds(this IClickableMenu menu, Int32 x, Int32 y, Int32 width, Int32 height) {
    ...
    public static void SetVisibleEx(this IClickableMenu menu, Boolean isVisible) {
      menu.allClickableComponents.ForEach((cc) => cc.visible = isVisible);
    }

    public static void draw(this InventoryMenu menu, SpriteBatch b, Color slotBorderColour) {
